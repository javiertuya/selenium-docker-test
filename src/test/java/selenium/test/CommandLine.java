...
public class CommandLine {
	...
	public static String runCommand(String command) {
		...
		try {
			...
			throw new RuntimeException("Can't execute command: " + command);
		}
		...
		try {
			...
			throw new RuntimeException("Can't get standard output from command: " + command);
		}
		return sw.toString();
	}
	...
	public static void fileDelete(String fileName, boolean throwIfNotExists) {
		try {
			...
			if (f.exists())
				...
				throw new RuntimeException("File to delete does not exist: " + fileName);
		} catch (IOException e) {
	...
	public static void fileCopy(String fileFrom, String fileTo) {
		try {
			...
			throw new RuntimeException("Can't copy " + fileFrom + " to " + fileTo);
		}
	}
